...
class Short extends Films{
    private String[] genre;
    private String release_date;
    private String[] writers;
    public boolean control_runtime=false;

    public Short(String film_id, String film_title, String language, String[] directors, int runtime, String country, String[] cast, String[] genre, String release_date, String[] writers,String filmtype) {
    ...
    @Override
    public void setRuntime(int runtime) {//Checking the length of the runtime
        if(runtime<=40){
            super.setRuntime(runtime);
            control_runtime=true;
        }
        else{
            System.out.println("This sort film is longer than 40 minutes.");
